...
const DashboardBluetooth = () => {
  const navigation = useNavigation<StackNavigationProp<ParamListBase>>();

  return (
    <View style={styles.dashboardBluetooth}>
      <Text style={[styles.econovr, styles.econovrTypo]}>EconoVR</Text>
      <Image
        style={[styles.dashboardBluetoothChild, styles.dashboardLayout]}
        resizeMode="cover"
        source={require("../assets/rectangle-4.png")}
      />
      <Image
        style={[styles.dashboardBluetoothItem, styles.dashboardLayout]}
        resizeMode="cover"
        source={require("../assets/rectangle-5.png")}
      />
      <Image
        style={[styles.dashboardBluetoothInner, styles.rectangleIconLayout]}
        resizeMode="cover"
      ...
      />
      <Image
        style={[styles.dashboardBluetoothChild1, styles.dashboardChildLayout]}
        resizeMode="cover"
        source={require("../assets/rectangle-8.png")}
      />
      <Image
        style={[styles.dashboardBluetoothChild2, styles.dashboardChildLayout]}
        resizeMode="cover"
      ...
      <View style={[styles.rectangleParent, styles.groupChild1Layout]}>
        ...
        <Pressable
          ...
          onPress={() => navigation.navigate("DashboardConnectedBluetooth")}
        >
          <View style={[styles.groupChild2, styles.groupLayout]} />
          <Text style={[styles.connectToBluetooth, styles.healvrTypo]}>
...
const styles = StyleSheet.create({
  ...
  dashboardBluetoothChild: {
    left: 54,
  },
  dashboardBluetoothItem: {
    left: 219,
  },
  dashboardBluetoothInner: {
    left: 54,
  },
  rectangleIcon: {
    left: 219,
  },
  dashboardBluetoothChild1: {
    left: 219,
  },
  dashboardBluetoothChild2: {
    left: 54,
  },
  vRaftedRealms: {
    top: 387,
...
export default DashboardBluetooth;
